...
public class UnknownInfluence extends AbstractArc
{
    /*
     * document constructor
     */
    public UnknownInfluence()
    {
        super (GlyphType.UNKNOWN_INFLUENCE);
    ...
    private void setEndCapCoordinates()
    {
        ...
        endCap_.lineTo(targetPoint.x - cap * 2.0F, targetPoint.y);
        endCap_.lineTo(targetPoint.x - cap, targetPoint.y + cap);
